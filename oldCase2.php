                ...
                <ul class="metismenu bg-light text-white" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./oldCase2.php?hospcode=<?=$d?>">- เพิ่มรายเก่า</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
...
if ($_REQUEST["act"] == 1) {
   ...
   $q1 = "SELECT off_name,off_id FROM office where off_id = '$pcu' and off_type IN('05','06','07') ";
	...
	if ($_FILES['fileDelivery']['name'] != "") {
        ...
        VALUES ('$hos', '$cid', '$fname', '$lname', '$sex', '$birth', '$disType', '$homeNo', '$mu', '$tambol', '$amper', '$tel', '$obt', '$pcu', 'OK', '$fileIdCard', '$fileHome', '$fileFace', '$fileBook', '$filePict', '$fileBank', '$fileIdCard2', '$fileHome2', '$fileConsent', '$fileCaregiver', '$fileCaregiverChange', '$fileAuthorize', '$fileDSCard', '$fileCard','$fileDelivery', now(), '$id_line')";
...
?>
<div class="container">
    <form name="form1" class="form-inline" action='oldCase2.php?act=1&hospcode=<?=$hospcode?>' method='post' enctype='multipart/form-data' autocomplete="off">
        <div class="container">
