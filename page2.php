...
$pmj_name = array(
    ...
    $sql_case = "select sum(case when c.statusCase='PMJ' then 1 else 0 end) as new_case
    , sum(case when c.statusCase='OBT' or infoFrom='OBT' then 1 else 0 end) as obt_case
    , sum(case when c.statusCase='DOC' or infoFrom='PMJ' then 1 else 0 end) as doc_case
    , sum(case when c.statusCase='OK' then 1 else 0 end) as ok_case
    from caseDis as c
    where c.tambol like '$province%'";
    ...
    <!--**********************************        Nav header start       ***********************************-->
        ...
        <div class="header">    
            <div class="header-content clearfix ">
                ...
                <p><h3 class="text-green"> &nbsp;&nbsp;&nbsp;    ระบบบริการคนพิการแบบเบ็ดเสร็จ  <font color="gray" size="2">&nbsp;&nbsp;&nbsp; One-stop Service for Disabilities</font></h3><h5>&nbsp;&nbsp;&nbsp;หน่วยงาน: สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัด<?=$province_name?></h5>
                </div>
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="page2.php?act=1"><i class="icon-key"></i> <span>ออกจากระบบ</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
		    ...
		    <li>
			    ...
			    <li><a href="./oldCase2.php?hospcode=<?=$d?>">- เพิ่มรายเก่า</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="listCm.php" target="_bkank">คนพิการที่ต้องการผู้ดูแล</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            ...
                            <!-- <a href="./listPMJ.php" target="_blank"> -->
                            <div class="card-body">
                                <h3 class="card-title text-white">ขอขึ้นทะเบียนรายใหม่</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo number_format($row_case["new_case"]); ?></h2>
                                </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            $id_line=$rs1->id_line;
            ?>
          <FORM name="form1" class="form-inline" ACTION ='page2.php?act=4&email=<?=$email?>' METHOD='post'  enctype='multipart/form-data'>  
            <div class="container"> 
