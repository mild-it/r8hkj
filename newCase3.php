...
if ($_REQUEST["act"] == 1) {
   ...
   $q1 = "SELECT * FROM office where subdistid = '$tambol' and off_type IN('05','06','07') ";
	...
	if ($_FILES['fileDelivery']['name'] != "") {
        ...
        VALUES ('$hos','$cid', '$fname', '$lname', '$sex', '$birth', '$disType', '$homeNo', '$mu', '$tambol', '$amper', '$tel', '$opt', '$pcu', 'PMJ', '$fileIdCard', '$fileHome', '$fileFace', '$fileBook', '$filePict', '$fileBank', '$fileIdCard2', '$fileHome2', '$fileConsent', '$fileCaregiver', '$fileCaregiverChange', '$fileAuthorize', '$fileDSCard', '$fileCard','$fileDelivery', now(), '$id_line','obt')";
...
?>
<div class="container">
    <form name="form1" class="form-inline" action='newCase3.php?act=1&hospcode=<?=$hospcode?>' method='post' enctype='multipart/form-data' autocomplete="off">
        <div class="container">
