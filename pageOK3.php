...
<?php
    ...
    $resultx = $mysqli->query("SELECT * from caseDis WHERE tambol like '$province%' and statusCase='OBT'  and obt='$d'");
    $countOBT=mysqli_num_rows($resultx);
    $resultx = $mysqli->query("SELECT * from caseDis WHERE tambol like '$province%' and statusCase='DOC' and infoFrom IN ('OBT','PMJ') and obt='$d'");
    $countDOC=mysqli_num_rows($resultx);
    $resultx = $mysqli->query("SELECT * from caseDis WHERE tambol like '$province%' and statusCase='OK'  and obt='$d'");
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="pageOK3.php?act=1"><i class="icon-key"></i> <span>ออกจากระบบ</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
...
<table class="table table-bordered table-striped">
    ...
    <?php 
		$num = 0;
		if($level=='pcu'){$sql = "SELECT * FROM caseDis where tambol like '$province%' and statusCase='OK' and hospcode='$d'";}  
			elseif($level=='opt'){$sql = "SELECT * FROM caseDis where tambol like '$province%' and statusCase='OK' and obt='$d1'";}
			else{$sql = "SELECT * FROM caseDis where tambol like '$province%' and statusCase='OK' ";} 
