...
$pmj_name = array(
    "38" => "สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดบึงกาฬ",
    "39" => "สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดหนองบัวลำภู",
    "41" => "สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดอุดรธานี",
    "42" => "สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดเลย",
    "43" => "สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดหนองคาย",
    "47" => "สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดสกลนคร",
    "48" => "สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดนครพนม"
);
$province = $_SESSION['province_pmj'];
    ...
    <!--**********************************     Nav header start    ***********************************-->
        ...
        <div class="header">    
            <div class="header-content clearfix ">
                ...
                <br><h3 class="text-green"> &nbsp;&nbsp;&nbsp;    ระบบบริการคนพิการแบบเบ็ดเสร็จ  <font color="gray" size="2">&nbsp;&nbsp;&nbsp; One-stop Service for Disabilities</font></h3><h5>&nbsp;&nbsp;&nbsp;หน่วยงาน: สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัด<?=$province_name?></h5>
                </div>
                ...
                <ul class="metismenu bg-light text-white" id="menu">
                    ...
                    <!-- <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./page2.php">- หน้าหลัก</a></li>
                        </ul>
                    </li> -->
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./newCase2.php?hospcode=<?=$d?>">- เพิ่มรายใหม่</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
...
if ($_REQUEST["act"] == 1) {
   ...
   $q1 = "SELECT off_name,off_id FROM office where off_id = '$pcu' and off_type IN('05','06','07') ";
    $result1 = $mysqli->query($q1);
    $rs1 = $result1->fetch_object();
    $off_name = $rs1->off_name;
    $hospcode = $rs1->cup_code;
	...
	if ($_FILES['fileDelivery']['name'] != "") {
        ...
        $sql = "INSERT INTO caseDis(hospcode, cid, fname, lname, sex, birth, disType, homeNo, mu, tambol, amper, tel, obt, pcucode, statusCase, fileIdCard, fileHome, fileFace, fileBook, filePict, fileBank, fileIdCard2, fileHome2, fileConsent, fileCaregiver, fileCaregiverChange, fileAuthorize, fileDSCard,fileCard,fileDelivery, dateREG, idSend)
        VALUES ('$hos', '$cid', '$fname', '$lname', '$sex', '$birth', '$disType', '$homeNo', '$mu', '$tambol', '$amper', '$tel', '$obt', '$pcu', 'OBT', '$fileIdCard', '$fileHome', '$fileFace', '$fileBook', '$filePict', '$fileBank', '$fileIdCard2', '$fileHome2', '$fileConsent', '$fileCaregiver', '$fileCaregiverChange', '$fileAuthorize', '$fileDSCard', '$fileCard','$fileDelivery', now(), '$id_line')";
        ...
        if ($result_newcase) {
            ...
            while ($result0 = mysqli_fetch_assoc($query0)) {
                ...
                $messages = array(
                    'type' => 'text',
                    'text' => 'โปรดตรวจสอบผู้ขอขึ้นทะเบียนรายใหม่ @จากหน่วยงาน :'.$off_name.'คลิ๊ก>> https://datacenter-r8way.moph.go.th/r8nds/page2.php',
                );
...
?>
<div class="container">
    <form name="form1" class="form-inline" action='newCase2.php?act=1&hospcode=<?=$hospcode?>' method='post' enctype='multipart/form-data' autocomplete="off">
        <div class="container">
            ...
            <div class="card-header">
                ...
                <div>
                  ...
                  <div class="input-group mb-3 input-group">
                        ...
                        <input type="file" class="form-control" name="fileCard" <?=$card?>>
                    </div>
                </div>
                <div class="input-group mb-3 input-group">
                    <div class="input-group-prepend">
                ...
                <div class="input-group mb-3 input-group">
                    ...
                    <div class="input-group mb-3 input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text">รูปถ่ายคนพิการ ทั้งตัว : </span>
                      </div>
