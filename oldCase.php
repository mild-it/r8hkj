...
if ($_REQUEST["act"] == 1) {
	...
	if ($_FILES['fileRequestMoney']['name'] != "") {
        ...
        VALUES ('$hospcode', '$cid', '$fname', '$lname', '$sex', '$birth', '$disType', '$homeNo', '$mu', '$tambol', '$amper', '$tel', '$obt', '$pcu', 'OK', '$fileIdCard', '$fileHome', '$fileFace', '$fileBook', '$filePict', '$fileBank', '$fileIdCard2', '$fileHome2', '$fileConsent', '$fileCaregiver', '$fileCaregiverChange', '$fileAuthorize', '$fileDSCard','$fileDelivery','$fileRequestMoney', now(), '$id_line')";
...
?>
<div class="container">
    <form name="form1" class="form-inline" action='oldCase.php?act=1&hospcode=<?=$hospcode?>' method='post' enctype='multipart/form-data' autocomplete="off">
        <div class="container">
