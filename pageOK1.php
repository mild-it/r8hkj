...
<?php
    ...
    $resultx = $mysqli->query("SELECT * from caseDis WHERE tambol like '$province%' and hospcode='$d' and statusCase='PMJ' ");
    $countPMJ=mysqli_num_rows($resultx);
    $resultx = $mysqli->query("SELECT * from caseDis WHERE tambol like '$province%' and hospcode='$d' and statusCase='OBT' ");
    $countOBT=mysqli_num_rows($resultx);
    $resultx = $mysqli->query("SELECT * from caseDis WHERE tambol like '$province%' and hospcode='$d' and statusCase='DOC' ");
    $countDOC=mysqli_num_rows($resultx);
    $resultx = $mysqli->query("SELECT * from caseDis WHERE tambol like '$province%' and hospcode='$d' and statusCase='OK' ");
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="pageOK1.php?act=1"><i class="icon-key"></i> <span>ออกจากระบบ</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="card gradient-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?=$countHOS?></h2>
                                </div>
		...
		<td class='text-center'> <?=($step_num*$e_page)+$num?></td>
	    	...
	    	<td class='text-center'>
				<!-- <button class="btn btn-info" data-toggle="modal" data-target="#myModal<?php echo $row['cid'] ?>"><i class="fa fa-search"></i></button> -->
                    ...
                    <a href="./editCase.php?cid=<?=$cid?>" class="btn btn-danger btn-sm" role="button"><i class="fa fa-pencil"></i></a> 
