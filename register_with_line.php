                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="line_register_db.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="username1" name="username" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="lastname">สกุล</label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="lastname1" name="lastname" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="cid">เลขบัตรประชาชน</label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="cid" name="cid" placeholder="" onfocusout="checkForm()" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="email">อีเมลล์ </label>
                                            <div class="col-lg-6">
                                                <input type="email" class="form-control" id="email1" name="email" placeholder="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="password1" name="password_1" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="provinces2" ></label>
                                                    <div class="col-md-6">                        
                                                    <select name="province_id1" id="province3" class="form-control" style="display: none">
                                        ...
                                        <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="provinces" ></label>
                                                    <div class="col-md-6">                        
                                                    <select name="province_id" id="province" class="form-control" style="display: none">
                                                    <option value="">-เลือกจังหวัด-</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <select name="hosp_id" id="hosp" class="form-control" style="display: none">
                                        ...
                                        <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="provinces2" ></label>
                                                    <div class="col-md-6">                        
                                                    <select name="province_id2" id="province2" class="form-control" style="display: none">
                                                    <option value="">-เลือกจังหวัด-</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <select name="opt_id" id="opt2" class="form-control" style="display: none">
